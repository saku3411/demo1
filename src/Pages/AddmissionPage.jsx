        ...
        <div className="content">
            <Header/>
                <div className="page-container">
                    <h1 className="demo2">Admissions at Vivekanand College</h1>
                ...
                <p>For detailed information on postgraduate program admissions, specific program syllabi, and fee structures, please visit our .<a href="CoursesPage"><u>Courses Page</u></a>or<a href="ContactPage"><u>Contact Page</u></a></p>
                 </div>
                 <Footer/>
                 </div>
